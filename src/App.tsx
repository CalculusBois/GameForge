...
export default function App() {
 ...
 {menu && <div className="menu-shade"><section ref={dialog} tabIndex={-1} className="game-menu" aria-label={`${menu} panel`}><div className="menu-heading"><div><p className="eyebrow">EXPEDITION PAUSED</p><h2>{{ inventory: 'Pack & equipment', crafting: 'Outpost crafting', cooking: 'Cooking station', skins: 'Explorer wardrobe', objectives: 'Earn coins', shop: 'Salvage exchange', map: 'Survey map', worlds: 'Your worlds', settings: 'Expedition settings', stats: 'Player stats & charts', forge: '✦ MIT Parley Generative Forge', storage: 'Storage crate' }[menu]}</h2></div><button onClick={close} disabled={pending}>Close & play ×</button></div><div className="menu-content">
 ...
 {menu === 'stats' && <StatsPanel world={world} />}
